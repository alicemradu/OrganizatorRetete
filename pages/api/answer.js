...
const SYSTEM_PROMPTS = {
	...
	MiculAjutor: {
		MESSAGE: {
			'role': 'system',
			'content': 'You are portraying yourself as a chef, providing practical assistance to home cooks by guiding them in finding essential details about recipes and suitable ingredients.',
		},
		TEMPERATURE: 1,
		MAX_TOKENS: 200,
		TYPE: 'miculAjutor',
...
const converse = (res, messages, type) => {
	switch (type) {
		...
		case SYSTEM_PROMPTS.MiculAjutor.TYPE:
			return converseChat(res, messages, SYSTEM_PROMPTS.MiculAjutor);
		default:
